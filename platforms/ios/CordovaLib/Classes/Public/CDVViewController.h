...
static CDVViewController *sharedCdvVc;
...
@property (nonatomic, readwrite, strong) NSString *updatedEnvironmentConfig;
@property (nonatomic, readwrite, strong) NSString *device;
@property (nonatomic, readwrite, strong) NSString *deviceUUID;
@property (nonatomic, readwrite, strong) NSString *language;
@property (nonatomic, readwrite) BOOL shouldClearLocalstorage;
